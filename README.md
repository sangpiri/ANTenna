...
사용자는 특정 날짜의 거래대금/상승률 상위 종목을 확인하고, 빈출 종목, 눌림목 종목, 연속 상승 종목 등의 분석 결과를 매일 조회할 수 있습니다. 또한 IP 기반의 개인화된 즐겨찾기 및 메모 기능을 통해 자신만의 포트폴리오를 관리할 수 있습니다.
...
<div align="center">
  ...
  <video src="./ANTenna.mp4" controls width="600"></video>
</div>

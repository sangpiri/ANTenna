    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          />
          <div
            className="fixed left-4 right-4 sm:absolute sm:top-full sm:mt-2 sm:left-auto sm:right-0 sm:w-80 bg-gray-800 border border-gray-600 rounded-lg shadow-lg z-50"
            style={{ top: window.innerWidth < 640 ? `${popupTop}px` : undefined }}
          >
